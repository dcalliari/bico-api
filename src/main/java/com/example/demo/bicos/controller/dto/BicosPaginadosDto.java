...
public record BicosPaginadosDto(Long id, String name, String description, String cidadeName, BigDecimal price, BicosFilter bicosFilter, @JsonFormat(pattern = "dd/MM/yyyy HH:mm:ss") LocalDateTime dataHoraServico) {
    public BicosPaginadosDto(Bicos bicos) {
