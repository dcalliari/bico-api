...
public class CandidaturaController {
    ...
    public ResponseEntity<List<CandidaturasDto>> listarMinhasCandidaturas(
        ...
        Page<CandidaturasDto> bicosPage = candidaturaService.minhasCandidaturasPaginadas(candidato.getId().toString(), page, size);
    ...
    public ResponseEntity<List<CandidaturaPendenteDto>> nivelPendente(
        ...
        Page<CandidaturaPendenteDto> bicosPage = candidaturaService.nivelPendentePaginado(aprovador.getId().toString(), page, size);
